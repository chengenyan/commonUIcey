...
extension UIBarButtonItem {
   ...
   public class func item(withTitle title: String?, target: Any?, action: Selector?, width: CGFloat) -> UIBarButtonItem {
   ...
   public class func item(withImage image: UIImage?, highlightImage: UIImage?, target: Any?, action: Selector?) -> UIBarButtonItem {
        let button = UIButton.init(type: .custom)
